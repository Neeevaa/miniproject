...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $password=$_POST['pswd'];
    if($username===$uname1 && $password===$pswd){
    ...
    if($username===$uname2 && $password===$pswd){
        $_SESSION['uname']=$username;
        header('Location:kitchenadmin.php');
        exit;
    }else {
        $error="Invalid Username or Password";
    }
    if($username===$uname3 && $password===$pswd){
        $_SESSION['uname']=$username;
        header('Location:chefsdashboard.php');
        exit;
    }else {
        $error="Invalid Username or Password";
    }
...
<a href="gallery.html" class="nav-item nav-link">Gallery</a>
                    ...
                    <!--<a href="login.php" class="btn btn-primary py-2 px-4 nav-item nav-link active">Login</a>-->
                </div>
            </nav>
         
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">For Administrative Purpose Only </h1>
...
<center>
            <div class="container-xxl py-10 px-5 wow fadeInUp align-items-center" data-wow-delay="0.1s">
            
            <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-center text-primary fw-normal">Admin Use</h5>
            ...
            <?php endif;?>
                        <form action="login.php" method="post"><fieldset>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating"><label for="name">User Name</label>
                                        <input type="text" class="form-control" id="uname" name="uname" placeholder="Enter User Name">
                                        
                                    </div>
                                </div><br>
                                <div class="col-md-6">
                                    <div class="form-floating"><label for="pswd">Password</label>
